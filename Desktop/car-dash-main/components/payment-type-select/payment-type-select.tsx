...
const PaymentTypeSelect = ({ defaultValue = '', className = 'form-select text-white-dark', onChange, name = 'payment_type', id }: PaymentTypeSelectProps) => {
    ...
    return (
        <div ref={wrapperRef} className="relative">
            ...
            {isOpen && (
                <div className="absolute left-0 right-0 mt-2 rounded-lg border border-gray-200 dark:border-[#374151] bg-white dark:bg-black shadow-lg shadow-black/10 dark:shadow-black/50 z-50">
