                    ...
                    return (
                        <div
                            ...
                            className={`cursor-pointer rounded-lg p-3 border-2 transition-all duration-200 transform ${
                                isSelected
                                    ? `${status.bgColor} ${status.borderColor} ${status.color} shadow-md dark:border-[#374151]`
                                    : `bg-gray-50 dark:bg-gray-800/50 border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 dark:border-[#374151]`
                            }`}
