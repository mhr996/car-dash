...
const AddCommission = () => {
    ...
    // الإجمالي قبل الضريبة من البنود، الضريبة = الإجمالي * 0.18
    const itemsTotalBeforeTax = items.reduce((sum, i) => sum + (i.unit_price || 0) * (i.quantity || 1), 0);
    const taxAmount = itemsTotalBeforeTax * 0.18;
    const totalWithTax = itemsTotalBeforeTax + taxAmount;
