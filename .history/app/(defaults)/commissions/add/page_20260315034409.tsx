...
const AddCommission = () => {
    ...
    const taxAmount = itemsTotal * 0.18;
                    ...
                    {(commissionType === 'tax_invoice' || commissionType === 'tax_invoice_receipt') && selectedProvider && (
                        <>
                            ...
                            <div className="bg-transparent rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                                <div className="grid grid-cols-[1fr_auto_auto_auto_auto] gap-4 mb-4 pb-2 border-b border-gray-300 dark:border-gray-600">
                                    <div className="text-sm font-bold text-gray-700 dark:text-white text-right">{t('item_description')}</div>
                                    <div className="text-sm font-bold text-gray-700 dark:text-white text-center w-24">{t('price')}</div>
                                    <div className="text-sm font-bold text-gray-700 dark:text-white text-center w-24">{t('quantity')}</div>
                                    <div className="text-sm font-bold text-gray-700 dark:text-white text-center w-24">{t('total')}</div>
                                    <div className="w-10" />
                                </div>
                                {items.map((item) => (
                                    <div key={item.id} className="grid grid-cols-[1fr_auto_auto_auto_auto] gap-4 mb-3 py-2 items-center">
                                        ...
                                        <div className="text-center">
                                            <input
                                                type="number"
                                                step="0.01"
                                                className="form-input text-sm text-center w-24"
                            ...
                            <div className="border-t border-gray-300 dark:border-gray-600 mt-6 pt-4 space-y-3">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-sm text-gray-700 dark:text-gray-300">₪{itemsTotal.toFixed(2)}</span>
                                </div>
                                <div className="flex justify-between items-center">
