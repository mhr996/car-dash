    ...
    return (
        <div>
            <div className="pt-5 max-w-[1500px]">
                ...
                {/* Deals by Type & Latest sales deals - جنباً إلى جنب */}
                    ...
                    <div className="panel">
                        ...
                        {stats.latestDeals.length === 0 ? (
                            ...
                            <table className="w-full text-sm">
                                ...
                                <tbody>
                                    {stats.latestDeals.slice(0, 5).map((deal: any) => (
                                        <tr key={deal.id} className="border-t border-gray-100 dark:border-[#191e3a] hover:bg-gray-50 dark:hover:bg-[#191e3a]/50">
                                            ...
                                            <td className="p-3 font-medium">{formatCurrency(deal.selling_price || 0)}</td>
                                            <td className="p-3">
                                                <Link href={`/sales-deals/preview/${deal.id}`} className="text-primary hover:underline">
                                                    <IconEye className="h-4 w-4 inline" />
                                                </Link>
                                            </td>
                                        </tr>
                                    ))}
                    ...
                    <div className="panel">
                        ...
                        {stats.dealsWithoutBills.length === 0 ? (
                            ...
                            <table className="w-full text-sm">
                                ...
                                <tbody>
                                    {stats.dealsWithoutBills.slice(0, 5).map((deal: any) => (
                                        <tr key={deal.id} className="border-t border-gray-100 dark:border-[#191e3a] hover:bg-gray-50 dark:hover:bg-[#191e3a]/50">
                                            <td className="p-3">#{deal.id}</td>
                                            <td className="p-3">
                                                {deal.deal_type === 'intermediary'
