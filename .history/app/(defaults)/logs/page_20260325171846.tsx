...
const LogsPage = () => {
    ...
    const getCarModelDetails = (log: Log) => {
        ...
        const showReturnedToCustomerAfterCancel =
            car.returned_to_customer === true || car.status === 'returned_to_customer';
        ...
        return (
            <div className="text-sm">
                ...
                {showReturnedToCustomerAfterCancel && (
                    <div className="mt-1 text-xs font-medium text-danger">{t('log_car_returned_to_customer_after_cancel')}</div>
                )}
            </div>
        );
    };
    ...
    const getPurchaseInfo = (log: Log) => {
        ...
        const purchasePriceLine = purchaseReturned ? (
            <div className="text-danger font-medium">({t('log_car_returned_to_customer_after_cancel')})</div>
