        ...
        if (deal && selectedCar) {
            ...
            if (selectedCar.buy_price) {
                items.push({
                    ...
                    name: 'מחיר קנייה',
                    price_type: 'G',
                    unit_price: selectedCar.buy_price,
                    units_number: 1,
                    unit_type: 1,
                    currency_code: 'ILS',
                    to_doc_currency_exchange_rate: 1,
    ...
    const handleCancelDealConfirm = async () => {
        ...
        try {
            ...
            if (hasBills && deal) {
                ...
                } else if (refundBillResult) {
                    // Create Tranzila document for refund bill
                    try {
                        ...
                        console.error('Error creating Tranzila document for refund:', tranzilaError);
                    }
